...
class Station(Producer):
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        logger.info(f"Sending message about train {train.train_id}")
        logger.info(
            f"More info: direction: {direction}, prev_station_id: {prev_station_id}, prev_direction: {prev_direction}."
        )
